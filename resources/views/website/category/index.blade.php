            ...
            <div class="container">
                ...
                <div class="row book-grid-row">
                    <div class="col-book style-1">
                        <div class="dz-shop-card style-1">
                            ...
                            <div class="dz-content">
                                <h5 class="title"><a href="{{route('product-detail')}}">Thunder Stunt</a></h5>
                                <ul class="dz-tags">
                    ...
                    <div class="col-book style-1">
                        <div class="dz-shop-card style-1">
                            <div class="dz-media">
                                <img src="{{asset('/')}}website/images/books/grid/book8.jpg" alt="book">
                            </div>
                            <div class="bookmark-btn style-2">
                    ...
                    <div class="col-book style-1">
                        <div class="dz-shop-card style-1">
                            <div class="dz-media">
                                <img src="{{asset('/')}}website/images/books/grid/book4.jpg" alt="book">
                            </div>
                            <div class="bookmark-btn style-2">
                    ...
                    <div class="col-book style-1">
                        <div class="dz-shop-card style-1">
                            <div class="dz-media">
                                <img src="{{asset('/')}}website/images/books/grid/book13.jpg" alt="book">
                            </div>
                            <div class="bookmark-btn style-2">
                    ...
                    <div class="col-book style-1">
                        <div class="dz-shop-card style-1">
                            <div class="dz-media">
                                <img src="{{asset('/')}}website/images/books/grid/book10.jpg" alt="book">
                            </div>
                            <div class="bookmark-btn style-2">
