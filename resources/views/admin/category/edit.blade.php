                ...
                <div class="card-body pt-5">
                    <form action="{{route('category.update', ['id' => $category->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" id="basic-default-name" value="{{$category->name}}" placeholder="Enter Category Name" />
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                ...
                                <img src="{{asset($category->image)}}" width="70" height="70" class="mt-3" alt="">
                            </div>
                        </div>
                        <div class="row mb-4">
